...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-2 md:p-3 bg-gradient-to-b from-black/20 to-transparent backdrop-blur-sm">
